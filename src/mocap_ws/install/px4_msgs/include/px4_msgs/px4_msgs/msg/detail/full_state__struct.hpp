...
#ifndef PX4_MSGS__MSG__DETAIL__FULL_STATE__STRUCT_HPP_
#define PX4_MSGS__MSG__DETAIL__FULL_STATE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4_msgs__msg__FullState __attribute__((deprecated))
#else
# define DEPRECATED__px4_msgs__msg__FullState __declspec(deprecated)
#endif
...
struct FullState_
{
  ...
  // pointer types
  using RawPtr =
    px4_msgs::msg::FullState_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4_msgs::msg::FullState_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4_msgs::msg::FullState_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4_msgs::msg::FullState_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4_msgs::msg::FullState_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::FullState_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::FullState_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4_msgs::msg::FullState_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4_msgs::msg::FullState_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4_msgs__msg__FullState
    std::shared_ptr<px4_msgs::msg::FullState_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4_msgs__msg__FullState
    std::shared_ptr<px4_msgs::msg::FullState_<ContainerAllocator> const>
...
using FullState =
  px4_msgs::msg::FullState_<std::allocator<void>>;

// constant definitions
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint32_t FullState_<ContainerAllocator>::MESSAGE_VERSION;
...
#endif  // PX4_MSGS__MSG__DETAIL__FULL_STATE__STRUCT_HPP_
