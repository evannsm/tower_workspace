...
: ${AMENT_CURRENT_PREFIX:="/src/mocap_ws/install/mocap_px4_relay"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mocap_px4_relay/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mocap_px4_relay/environment/path.sh"
