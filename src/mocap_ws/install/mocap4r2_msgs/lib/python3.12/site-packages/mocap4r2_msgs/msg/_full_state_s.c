...
bool mocap4r2_msgs__msg__full_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mocap4r2_msgs.msg._full_state.FullState", full_classname_dest, 39) == 0);
  }
  mocap4r2_msgs__msg__FullState * ros_message = _ros_message;
  {  // position
...
PyObject * mocap4r2_msgs__msg__full_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mocap4r2_msgs.msg._full_state");
