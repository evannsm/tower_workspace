...
#include "px4_msgs/msg/detail/full_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4_msgs::msg::FullState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs::msg::FullState & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4_msgs::msg::FullState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4_msgs::msg::FullState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_msgs::msg::FullState *>(
    untyped_ros_message);
...
{
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_FullState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, msg, FullState)() {
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_FullState__handle;
}
